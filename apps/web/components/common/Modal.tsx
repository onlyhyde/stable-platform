        ...
        >
          ...
          {(title || description) && (
            <div className="px-6 pt-6 pb-4 border-b" style={{ borderColor: 'rgb(var(--border))' }}>
              ...
              {description && (
                <p className="mt-1.5 text-sm" style={{ color: 'rgb(var(--muted-foreground))' }}>{description}</p>
              )}
            </div>
          )}
  ...
  const icons = {
    danger: (
      <div className="w-12 h-12 rounded-full flex items-center justify-center mb-4"
        ...
        <svg className="w-6 h-6" style={{ color: 'rgb(var(--destructive))' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    info: (
      <div className="w-12 h-12 rounded-full flex items-center justify-center mb-4"
        ...
        <svg className="w-6 h-6" style={{ color: 'rgb(var(--info))' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="sm" showClose={false}>
      <div className="text-center">
        ...
        {description && (
          <p className="text-sm mb-6" style={{ color: 'rgb(var(--muted-foreground))' }}>{description}</p>
        )}
