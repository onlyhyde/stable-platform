...
const footerLinks = {
  product: [
    { name: 'Smart Account', href: '/smart-account' },
    { name: 'DeFi', href: '/defi' },
...
const socialLinks = [
  {
    name: 'GitHub',
    href: 'https://github.com/stablenet',
    icon: (
  ...
  {
    name: 'Twitter',
    href: 'https://twitter.com/stablenet',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    name: 'Discord',
    href: 'https://discord.gg/stablenet',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
export function Footer() {
  return (
    ...
    >
      ...
      {/* Bottom Bar */}
      <div className="border-t py-6 px-6" style={{ borderColor: 'rgb(var(--border))' }}>
