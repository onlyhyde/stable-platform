...
export default function StealthSendPage() {
  ...
  if (!isConnected) {
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <p className="text-gray-500">Please connect your wallet to send privately</p>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-lg mx-auto space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Private Send</h1>
        <p className="text-gray-500">Send tokens to a stealth meta-address</p>
      </div>
