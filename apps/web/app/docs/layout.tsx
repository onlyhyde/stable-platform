              ...
              return (
                <div key={section.slug}>
                  <div className="flex items-center gap-2 mb-2">
                    <span style={{ color: isSectionActive ? 'rgb(var(--primary))' : 'rgb(var(--muted-foreground))' }}>
                      {iconMap[section.icon]}
                    </span>
                    <span
                      className="text-sm font-semibold uppercase tracking-wider"
                      style={{ color: isSectionActive ? 'rgb(var(--primary))' : 'rgb(var(--muted-foreground))' }}
                    >
                      {section.title}
                    </span>
                  </div>
                      ...
                      return (
                        <li key={article.slug}>
                          <Link
                            ...
                            style={{
                              backgroundColor: isActive ? 'rgb(var(--primary) / 0.1)' : 'transparent',
