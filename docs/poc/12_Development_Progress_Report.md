...
```
Sprint 1 (Week 1-2): SDK 플러그인 테스트 (✅ PG Simulator 검증 완료)
Sprint 2 (Week 3-4): SDK 나머지 테스트 (✅ Bridge Relayer 구현 완료)
Sprint 3 (Week 5-6): E2E 테스트 + Go 서비스 테스트
Sprint 4 (Week 7-8): 상수 외부화 + 에러 처리 + 문서화
```
