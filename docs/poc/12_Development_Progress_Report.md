...
| **@stablenet/registry-client** | ✅ 100% | RegistryClient, React hooks (useContract, useAddressSet, useRegistryStatus) |
...
| **contract-registry** | TypeScript/Fastify | ✅ 100% | REST API, WebSocket 실시간 알림, Foundry 아티팩트 감시, JSON 영속성 (24개 소스, 40개 테스트) |
...
| 2026-01-27 | 2.2 | Contract Registry Service 구현 완료: services/contract-registry (24 소스, 40 테스트), packages/registry-client (7 소스, React hooks) 추가 |
