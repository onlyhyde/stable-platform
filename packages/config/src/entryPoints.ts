 ...
 * @deprecated Use ENTRY_POINT_V07 for new deployments
 */
 ...
 */
export const CURRENT_ENTRY_POINT_VERSION = 'V07' as const

/**
 * Current recommended EntryPoint address
 */
export const ENTRY_POINT_ADDRESS = ENTRY_POINT_V07
 ...
 */
export function getEntryPointVersion(address: Address): 'V07' | 'V06' | null {
  const normalized = address.toLowerCase()
