 ...
 * EntryPoint Module
 *
 * EntryPoint v0.7 constants, ABI, and version detection utilities.
 */
 ...
 * @returns 'v0.6' | 'v0.7' | 'unknown'
 */
export function getEntryPointVersion(address: Address): 'v0.6' | 'v0.7' | 'unknown' {
...
/**
 * Type guard: check if address is the v0.7 EntryPoint.
 */
