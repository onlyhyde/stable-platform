// Package logger provides structured logging utilities for the subscription-executor service.
package logger
...
func New(cfg Config) *Logger {
	...
	if cfg.Name == "" {
		cfg.Name = "subscription-executor"
	}
...
func (l *Logger) WithSubscription(subscriptionID string) *Logger {
	return l.With(slog.String("subscriptionID", subscriptionID))
}
